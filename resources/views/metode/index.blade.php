        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            $('#datatables-basic').on('draw.dt', function() {
                        ...
                        editRecord.forEach(el => {
                            el.addEventListener('click', function() {
                                ...
                                offCanvasUpdateElement.querySelector(
                                    ...
                                    .value = data.id;
                                offCanvasUpdateElement.querySelector(
                                        '.dt-kode-metode').value =
                                    data.metode_kode;
                                offCanvasUpdateElement.querySelector(
                                        '.dt-nama-metode').value =
                                    data.metode_nama;
                ...
                fvedit.on('core.form.valid', function() {
                    ...
                    if (metode_kode != '') {
                        $.ajax({
                            url: "{{ route('master.metode.update', ['id' => ':id']) }}"
                                .replace(':id',
                                    id),
                            type: 'PATCH',
                            data: {
                    ...
                    document.querySelectorAll('.delete-record').forEach(function(element) {
                        element.addEventListener('click', function() {
                            ...
                            Swal.fire({
                                ...
                                text: 'Data metode Inspeksi ' + data
                                    .metode_nama +
                                    ' akan dihapus!',
                                icon: 'warning',
                                ...
                                if (result.isConfirmed) {
                                    $.ajax({
                                        url: "{{ route('master.metode.destroy', ['id' => ':id']) }}"
                                            .replace(':id', data
                                                .id),
                                        type: 'DELETE',
                                        data: {
...
@section('content')
    <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Master /</span> Metode Inspeksi</h4>
    ...
    <div class="offcanvas offcanvas-end" id="add-new-record">
        ...
        <div class="offcanvas-body flex-grow-1">
            <form class="add-new-record pt-0 row g-2" id="form-add-new-record">
                <div class="col-sm-12">
                    <label class="form-label" for="metode_kode">{{ __('Kode Metode') }}</label>
                    <div class="input-group input-group-merge">
                        <input type="text" id="metode_kode" class="form-control dt-kode-metode" name="metode_kode"
                            placeholder="XX" aria-label="XX" required />
                    </div>
                </div>
                <div class="col-sm-12">
                    <label class="form-label" for="metode_nama">{{ __('Nama Metode') }}</label>
                    <div class="input-group input-group-merge">
                        <input type="text" id="metode_nama" name="metode_nama" class="form-control dt-nama-metode"
                            placeholder="Pest Management Control" aria-label="Pest Management Control" required />
                    </div>
                </div>
                <div class="col-sm-12">
                    <label class="form-label" for="metode_jenis">{{ __('Jenis Metode') }}</label>
                    <div class="input-group input-group-merge">
                        <select class="form-select dt-jenis-metode" id="metode_jenis" name="metode_jenis"
    ...
    <div class="offcanvas offcanvas-end" id="update-record" tabindex="-1">
        ...
        <div class="offcanvas-body flex-grow-1">
            <form class="update-record pt-0 row g-2" id="form-update-record">
                <div class="col-sm-12">
                    <input type="hidden" id="id-edit" class="form-control dt-id-edit-metode" name="id-edit" required
                        readonly />
                </div>
                <div class="col-sm-12">
                    <label class="form-label" for="metode_kode">{{ __('Kode Metode') }}</label>
